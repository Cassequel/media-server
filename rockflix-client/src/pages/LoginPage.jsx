        ...
        <div className="w-full max-w-sm">
          ...
          <footer className="mt-24 opacity-30">
            <div className="flex items-center gap-6">
              <div>
                <p className="text-[10px] uppercase tracking-tighter" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Personal Server</p>
                <p className="text-[10px]" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Secure Access</p>
              </div>
              <div className="h-6 w-px bg-[#5b4138]" />
              <div>
                <p className="text-[10px] uppercase tracking-tighter" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Encryption</p>
                <p className="text-[10px]" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>AES-256</p>
              </div>
            </div>
          </footer>
        </div>
